...
printf "\x1b[34m======================================================\n"
printf "==            Mainnet upgradeTo: ${COLOR}${IS_MAINNET}\x1b[34m            ===\n"
printf "======================================================\x1b[0m\n"
...
# Deploy contracts
forge script script/upgradeTo.s.sol:UpgradeTo --slow --broadcast --ledger --hd-paths $HD_PATHS --ffi --zksync --rpc-url $RPC_URL --chain $CHAIN_ID --verify --verifier etherscan --verifier-url $VERIFY_URL --etherscan-api-key $API_KEY
