...
# Deploy contractsy
forge script script/DeployDispenser.s.sol:DeployDispenser --slow --broadcast --ledger --hd-paths $HD_PATHS --ffi --zksync --rpc-url $RPC_URL --chain $CHAIN_ID --verify --verifier etherscan --verifier-url $VERIFY_URL --etherscan-api-key $API_KEY
